...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final AlifLibraryAccessors laccForAlifLibraryAccessors = new AlifLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at alif
     */
    public AlifLibraryAccessors getAlif() {
        return laccForAlifLibraryAccessors;
    }
    ...
    public static class AlifLibraryAccessors extends SubDependencyFactory {

        public AlifLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for core (com.alif:core)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCore() {
                return create("alif.core");
        }
